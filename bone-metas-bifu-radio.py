...
# -> parametros
# fijos
a1=0.5;a2=0.05;b1=0.2;b2=0.02;g1=-0.3;g2=0.7;K=10000.0;b3=0.0;c2=0.0;bifl = 0.0;
...
# MATLAB
# SIM01
#a3=1.5e-2;c1=1.e-6;c3=1e-3;c4=0.0;rango=[0e4,1e4];bifr = 0.02;

# SIM02
#a3=1.0e-4;c1=1.e-6;c3=1e-3;c4=0.0;rango=[0e4,5e4];bifr = 0.0005;

# SIM03
a3=1.e-4;c1=0.0;c3=1.e-8;c4=-1.e-4;rango=[0e4,6e3];bifr = 0.0001;
...
bif = np.linspace(bifl,bifr,2e2);
x0cancer = np.zeros((4,len(bif)))

for i in range(len(bif)):
    x0cancer[:,i] = obtenereq(a1,a2,b1+bif[i],b2+bif[i],g1,g2,K,a3,b3+bif[i],c1,c2,c3,c4)
...
plt.xlabel(r'Radiation $u_R$',fontsize=16)
